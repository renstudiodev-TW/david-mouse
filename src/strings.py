...
STRINGS: Dict[str, Dict[str, str]] = {
    "zh-TW": {
        ...
        "btn_double": "◐◐ 雙擊",
        "btn_dictation": "🎙 語音聽寫",
        "countdown_dictation": "{n} 秒後啟動語音聽寫",
        "dwell_label": "停留時間：{value} 秒",
        "autostart": "開機自動啟動",
        "autostart_on": "✔ 開機自動啟動：開",
        "autostart_on_admin": "✔ 開機自動啟動：開（管理員）",
    ...
    "en": {
        ...
        "btn_right": "◑ Right",
        "btn_double": "◐◐ Double",
        "btn_dictation": "🎙 Dictation",
        "countdown_dictation": "Voice dictation in {n}s",
        "dwell_label": "Dwell time: {value} s",
        "autostart": "Start with Windows",
        "autostart_on": "✔ Start with Windows: ON",
        "autostart_on_admin": "✔ Start with Windows: ON (Admin)",
